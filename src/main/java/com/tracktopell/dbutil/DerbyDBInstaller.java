...
public class DerbyDBInstaller extends DBInstaller {
    ...
    private void setDBSystemDir() {
        ...
        derbyHome=new File("apache-derby_db");
        
        String systemDir = derbyHome.getAbsolutePath() + File.separator+parameters4CreateAndExecute.getProperty("app.dataDirectory","app.dataDirectory");
